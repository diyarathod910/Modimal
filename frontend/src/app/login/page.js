                    ...
                    <div className="w-[85%] flex ">
                        ...
                        <div className="w-[50%] flex flex-col items-center mt-[8%] gap-5">
                            ...
                            <form className="flex flex-col w-[60%] gap-5">
                                ...
                                <input type="text" name="email" value={user.email} onChange={handleChange} placeholder="email" className="w-full border-2 border-[#606060] p-3"></input>
                                <input type="password" name="password" value={user.password} onChange={handleChange} placeholder="password" className="w-full border-2 border-[#606060] p-3"></input>

                                <a className="text-[#748C70] hover:cursor-pointer ">Forgot your password?</a>
                                <button onClick={handleLogin} className="bg-[#5A6D57] w-full py-3 text-white text-[14px] hover:cursor-pointer ">log in</button>
                            </form>
                            ...
                            <p className="w-[60%] text-center capitalize text-[12px]">New to modimal?  </p>
                            <Link href="/register" className="text-[#748C70] underline">create an account</Link>
                        </div>
                    </div>
